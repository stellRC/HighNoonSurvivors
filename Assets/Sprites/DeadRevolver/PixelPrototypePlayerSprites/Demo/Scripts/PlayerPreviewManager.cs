...
namespace DeadRevolver.PixelPrototypePlayer
{
    ...
    public class PlayerPreviewManager : MonoBehaviour
    {
        ...
        public UnityEvent<
            PlayerPreviewAnimation,
            int,
            List<PlayerPreviewAnimation>
        > onAnimationChanged;
        ...
        private void UpdateAnimation()
        {
            ...
            if (
                currentAnimation.name == "Ledge Hang"
                || currentAnimation.name == "Ledge Climb"
                || currentAnimation.name == "Wall Slide"
                || currentAnimation.name == "Wall Jump"
                || currentAnimation.name == "Wall Climb"
                || currentAnimation.name == "Wall Climb Idle"
            )
            {
            ...
            if (
                currentAnimation.name == "Ladder Climb"
                || currentAnimation.name == "Ladder Climb Finish"
            )
            {
            ...
            if (
                currentAnimation.name == "Climb Up (Left Hand)"
                || currentAnimation.name == "Climb Up (Right Hand)"
                || currentAnimation.name == "Climb Down (Left Hand)"
                || currentAnimation.name == "Climb Down (Right Hand)"
                || currentAnimation.name == "Climb Left"
                || currentAnimation.name == "Climb Right"
                || currentAnimation.name == "Climb Idle"
                || currentAnimation.name == "Climb Grab/Land"
                || currentAnimation.name == "Climb Jump Prepare"
            )
            {
