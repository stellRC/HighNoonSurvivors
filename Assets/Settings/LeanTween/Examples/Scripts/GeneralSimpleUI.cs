...
public class GeneralSimpleUI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LeanTween
            .value(button.gameObject, button.anchoredPosition, new Vector2(200f, 100f), 1f)
            .setOnUpdate(
                (Vector2 val) =>
                {
        ...
        LeanTween
            ...
            .setOnUpdate(
                (Color val) =>
                {
                    UnityEngine.UI.Image image = (UnityEngine.UI.Image)
                        button.gameObject.GetComponent(typeof(UnityEngine.UI.Image));
                    image.color = val;
                }
            );
        ...
        LeanTween
            .rotateAround(button, Vector3.forward, -90f, 1f)
            .setDelay(4f)
