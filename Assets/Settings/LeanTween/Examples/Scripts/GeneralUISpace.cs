...
public class GeneralUISpace : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LeanTween
            .scale(mainWindow, new Vector3(1f, 1f, 1f), 0.6f)
            .setEase(LeanTweenType.easeOutBack);
        LeanTween
            .alphaCanvas(mainWindow.GetComponent<CanvasGroup>(), 0f, 1f)
            .setDelay(2f)
            .setLoopPingPong()
            .setRepeat(2);
        ...
        LeanTween
            .textAlpha(mainParagraphText, 1f, 0.6f)
        ...
        LeanTween
            .textColor(mainTitleText, new Color(133f / 255f, 145f / 255f, 223f / 255f), 0.6f)
            .setEase(LeanTweenType.easeOutQuad)
            .setDelay(0.6f)
            .setLoopPingPong()
            .setRepeat(-1);
        ...
        // Fade button in
        LeanTween
            .textAlpha(mainButton2, 1f, 2f)
            .setFrom(0f)
            .setDelay(0f)
            .setEase(LeanTweenType.easeOutQuad);
        LeanTween
            .alpha(mainButton2, 1f, 2f)
            .setFrom(0f)
            .setDelay(0f)
            .setEase(LeanTweenType.easeOutQuad);
        ...
        // Pop size of button
        LeanTween
            .size(mainButton1, mainButton1.sizeDelta * 1.1f, 0.5f)
            .setDelay(3f)
            .setEaseInOutCirc()
            .setRepeat(6)
            .setLoopPingPong();
        ...
        LeanTween
            .moveY(pauseWindow, pauseWindow.anchoredPosition3D.y + -200f, 0.6f)
        ...
        LeanTween
            .moveZ(pauseText, pauseText.anchoredPosition3D.z - 80f, 1.5f)
        ...
        LeanTween
            .rotateAround(chatWindow, Vector3.up, 180f, 2f)
        ...
        LeanTween
            .color(chatBar2, new Color(248f / 255f, 67f / 255f, 108f / 255f, 0.5f), 1.2f)
            .setEase(LeanTweenType.easeInQuad)
            .setLoopPingPong()
            .setDelay(1.2f);
        LeanTween
            .scale(chatBar2, new Vector2(1f, 0.7f), 1.2f)
            .setEase(LeanTweenType.easeInQuad)
            .setLoopPingPong();
        ...
        chatText.text = "";
        LeanTween
            .value(gameObject, 0, (float)origText.Length, 6f)
            .setEase(LeanTweenType.easeOutQuad)
            .setOnUpdate(
                (float val) =>
                {
