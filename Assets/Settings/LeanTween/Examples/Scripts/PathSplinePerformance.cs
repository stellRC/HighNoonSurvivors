...
public class PathSplinePerformance : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            float x =
                Mathf.Cos(degree * Mathf.Deg2Rad) * circleLength + Random.Range(0f, randomRange);
            float z =
                Mathf.Sin(degree * Mathf.Deg2Rad) * circleLength + Random.Range(0f, randomRange);
        ...
        LeanTween
            .moveSpline(trackTrailRenderers, track, tracerSpeed)
    ...
    void Update()
    {
        ...
        if (Input.anyKeyDown)
        {
            ...
            LeanTween
                .moveLocalX(carInternal, (trackIter - 1) * 6f, 0.3f)
    ...
    void playSwish()
    {
        ...
        AnimationCurve frequencyCurve = new AnimationCurve(
        ...
        AudioClip audioClip = LeanAudio.createAudio(
            ...
            LeanAudio
                .options()
                .setVibrato(new Vector3[] { new Vector3(0.2f, 0.5f, 0f) })
                .setWaveNoise()
