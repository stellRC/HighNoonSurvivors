...
public class TestingRotate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LeanTween
            .rotateAround(earth, earth.transform.up, 360f, 5.0f)
            .setPoint(sunLocalForEarth)
            .setRepeat(-1);

        //method 2 leantween
        Vector3 sunLocalForEarth2 = earth2.transform.InverseTransformPoint(sun2.transform.position);
        LeanTween
            .rotateAroundLocal(earth2, earth2.transform.up, 360f, 5.0f)
            .setPoint(sunLocalForEarth2);
    }

    void Update()
    {
        //method 3 unity3d
        earth3.transform.RotateAround(
            sun3.transform.position,
            sun3.transform.up,
            72f * Time.deltaTime
        );
    }
